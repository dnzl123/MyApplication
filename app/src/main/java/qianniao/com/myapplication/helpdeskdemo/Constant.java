 ...
 */
package qianniao.com.myapplication.helpdeskdemo;


public class Constant {

	public static final String DEFAULT_CUSTOMER_APPKEY = "1128170214178682#mdome";
	public static final String DEFAULT_CUSTOMER_ACCOUNT = "qct123";
	public static final String DEFAULT_ACCOUNT_PWD = "123123";
	public static final String DEFAULT_NICK_NAME = "";
	public static final String DEFAULT_TENANT_ID = "35861";
